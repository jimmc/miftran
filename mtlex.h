 ...
 */
/* mtlex.h - external interface file for mtlex.c */

void MtCopyToken ARGS((MtToken *src, MtToken *dest));
void MtUngetToken ARGS((MtInfo *mti));
int MtGetToken ARGS((MtInfo *mti));
void MtPrintToken ARGS((FILE *f, MtInfo *mti, MtToken *token));
